...
<div class="copy-right">
	<div class="container" style="background-color:DodgerBlue;">
		...
		<div class="footer-social-icons wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown; background-color:IndianRed;">
			<ul>
